---
title: "Concurreny & Multithreading: All you need to know"
summary: "A complete guide to understanding concurrency and multithreading in programming. Covers core concepts, differences between processes, threads, and tasks, explores Java’s Runnable, Callable, Executor, and Future, and explains synchronization, race conditions, and thread safety with practical examples."
publishedAt: "2025-08-22"
tag: ["System Design", "Java", "Multithreading"]
---

## Threads

Fundamental units of execution that allows programs to perform multiple tasks concurrently. Threads can utilize [multi-core](#multicore) processors efficiently and improve overall application performance.
...
### 1. Extending the `Thread` class
   ...
   ```
   Refer for complete example [here](https://github.com/divyadhimaan/lld-playground/tree/main/code/multithreading/ThreadExample.java)
...
### 2. Implementing the `Runnable` interface
   ...
   ```
   Refer for complete example [here](https://github.com/divyadhimaan/lld-playground/tree/main/code/multithreading/RunnableExample.java)
...
### 3. Implementing `Callable` Interface
   ...
   ```
   Refer for complete example [here](https://github.com/divyadhimaan/lld-playground/tree/main/code/multithreading/CallableExample.java)
